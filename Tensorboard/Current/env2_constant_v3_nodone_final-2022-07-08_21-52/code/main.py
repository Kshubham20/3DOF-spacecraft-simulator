...
writer = tf.summary.create_file_writer(Settings.MODEL_SAVE_DIRECTORY + filename, filename_suffix = Settings.TENSORBOARD_FILE_EXTENSION)
...
with tf.compat.v1.Session(config = config) as sess:
    ...
    tf.compat.v1.writer.add_graph(sess.graph)
    print('Done starting!')
