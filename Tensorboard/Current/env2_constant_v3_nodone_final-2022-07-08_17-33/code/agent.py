...
class Agent:
    ...
    def build_actor(self):
        ...
        self.state_placeholder = tf.compat.v1.placeholder(dtype = tf.float32, shape = [None, Settings.STATE_SIZE], name = 'state_placeholder') # the * lets Settings.STATE_SIZE be not restricted to only a scalar
